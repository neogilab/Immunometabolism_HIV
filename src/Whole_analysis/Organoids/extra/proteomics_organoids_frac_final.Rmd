...
```{r}
pca_data <- data.frame(Name = pca_data$Name, condition = pca_data$condition, t(data_norm))
```
...
write.csv(top_table[, c(6, 2, 3)], paste0("processing/GSEA/proteomics_organoids_SPD_controls_frac.csv"), quote = FALSE, row.names = F)

top_table <- top_table[complete.cases(top_table),]
top_table$Gene_name <- mapIds(org.Hs.eg.db, as.vector(top_table$BIOCHEMICAL), keytype="UNIPROT", column="SYMBOL")
path_table <- paste0("results/LIMMA/DGE_table_proteomics_organoids_SPD_controls_frac.csv")
...
path_results <- paste0("results/LIMMA/DGE_table_proteomics_organoids_SPD_controls_frac_filt.csv")

write.table(DF_top_table, file = path_results)

path_results <- paste0("results/LIMMA/DGE_table_proteomics_organoids_SPD_controls_frac_filt.xlsx")
...
print(vol)
path_fig <- paste0("results/figures/volcano_plot_proteomics_organoids_SPD_controls_frac.pdf")
...
top_table <- top_table[,c(8, 1, 4, 5, 7)]
top_table$Gene_name <- mapIds(org.Hs.eg.db, as.vector(top_table$BIOCHEMICAL), keytype="UNIPROT", column="SYMBOL")
write.csv(top_table[, c(6, 2, 3)], paste0("processing/GSEA/proteomics_organoids_at-risk_controls_frac.csv"), quote = FALSE, row.names = F)

top_table <- top_table[complete.cases(top_table),]
top_table$Gene_name <- mapIds(org.Hs.eg.db, as.vector(top_table$BIOCHEMICAL), keytype="UNIPROT", column="SYMBOL")
path_table <- paste0("results/LIMMA/DGE_table_proteomics_organoids_at-risk_controls_frac.csv")
...
path_results <- paste0("results/LIMMA/DGE_table_proteomics_organoids_at-risk_controls_frac_filt.csv")

write.table(DF_top_table, file = path_results)

path_results <- paste0("results/LIMMA/DGE_table_proteomics_organoids_at-risk_controls_frac_filt.xlsx")
...
top_table <- top_table[,c(8, 1, 4, 5, 7)]
top_table$Gene_name <- mapIds(org.Hs.eg.db, as.vector(top_table$BIOCHEMICAL), keytype="UNIPROT", column="SYMBOL")
write.csv(top_table[, c(6, 2, 3)], paste0("processing/GSEA/proteomics_organoids_hc-like_controls_frac.csv"), quote = FALSE, row.names = F)

top_table <- top_table[complete.cases(top_table),]
top_table$Gene_name <- mapIds(org.Hs.eg.db, as.vector(top_table$BIOCHEMICAL), keytype="UNIPROT", column="SYMBOL")
path_table <- paste0("results/LIMMA/DGE_table_proteomics_organoids_hc-like_controls_frac.csv")
...
path_results <- paste0("results/LIMMA/DGE_table_proteomics_organoids_hc-like_controls_frac_filt.csv")

write.table(DF_top_table, file = path_results)

path_results <- paste0("results/LIMMA/DGE_table_proteomics_organoids_hc-like_controls_frac_filt.xlsx")
...
top_table <- top_table[,c(8, 1, 4, 5, 7)]
top_table$Gene_name <- mapIds(org.Hs.eg.db, as.vector(top_table$BIOCHEMICAL), keytype="UNIPROT", column="SYMBOL")
write.csv(top_table[, c(6, 2, 3)], paste0("processing/GSEA/proteomics_organoids_hc-like_at-risk_frac.csv"), quote = FALSE, row.names = F)

top_table <- top_table[complete.cases(top_table),]
top_table$Gene_name <- mapIds(org.Hs.eg.db, as.vector(top_table$BIOCHEMICAL), keytype="UNIPROT", column="SYMBOL")
path_table <- paste0("results/LIMMA/DGE_table_proteomics_organoids_hc-like_at-risk_frac.csv")
...
path_results <- paste0("results/LIMMA/DGE_table_proteomics_organoids_hc-like_at-risk_frac_filt.csv")

write.table(DF_top_table, file = path_results)

path_results <- paste0("results/LIMMA/DGE_table_proteomics_organoids_hc-like_at-risk_frac_filt.xlsx")
...
print(vol)
path_fig <- paste0("results/figures/volcano_plot_proteomics_organoids_hc-like_at-risk_frac.pdf")
ggsave(path_fig, width = 6, height = 2.5)
```
```{r}
...
top_table <- top_table[,c(8, 1, 4, 5, 7)]
top_table$Gene_name <- mapIds(org.Hs.eg.db, as.vector(top_table$BIOCHEMICAL), keytype="UNIPROT", column="SYMBOL")
write.csv(top_table[, c(6, 2, 3)], paste0("processing/GSEA/proteomics_organoids_hc-like_at-risk_corrected_frac.csv"), quote = FALSE, row.names = F)

top_table <- top_table[complete.cases(top_table),]
top_table$Gene_name <- mapIds(org.Hs.eg.db, as.vector(top_table$BIOCHEMICAL), keytype="UNIPROT", column="SYMBOL")
path_table <- paste0("results/LIMMA/DGE_table_proteomics_organoids_hc-like_at-risk_corrected_frac.csv")
...
path_results <- paste0("results/LIMMA/DGE_table_proteomics_organoids_hc-like_at-risk_corrected_frac_filt.csv")

write.table(DF_top_table, file = path_results)

path_results <- paste0("results/LIMMA/DGE_table_proteomics_organoids_hc-like_at-risk_corrected_frac_filt.xlsx")
...
print(vol)
path_fig <- paste0("results/figures/volcano_plot_proteomics_organoids_hc-like_at-risk_corrected_frac.pdf")
ggsave(path_fig, width = 6, height = 2.5)
```
